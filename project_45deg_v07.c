...
const void Input()
{
  if (GetAsyncKeyState('A')) point.x-=10;
  if (GetAsyncKeyState('D')) point.x+=10;
  if (GetAsyncKeyState('W')) point.y-=10;
  if (GetAsyncKeyState('S')) point.y+=10;
  if (GetAsyncKeyState('Q')) point.z+=10;
  if (GetAsyncKeyState('Z')) point.z-=10;
...
const xyz ObjectPoints0000[]={ {-900,-1000,-1000}, {900,-1000,-1000}, {-900,1000,-1000}, {900,1000,-1000}, {-900,-1000,1000}, {900,-1000,1000}, {-900,1000,1000}, {900,1000,1000} }; 
